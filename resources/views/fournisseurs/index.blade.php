                                    ...
                                    <tbody>
                                        @forelse($fournisseurs as $fournisseur)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $fournisseur->postnom }} </td>
                                                <td class="text-center">{{ $fournisseur->prenom }}</td>
                                                <td class="text-center">{{ $fournisseur->telephone }}</td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm fas fa-eye" data-toggle="modal"
                                                        data-target="" href="#"></a>
                                                    <a class="btn btn-danger btn-sm" href="{{route('fournisseurs.destroy',$fournisseur->id)}}" >
                                            ...
                                            @endphp
                                        @empty
                                            <td colspan="12">Aucune information</td>
                                        @endforelse
